...
def add_data_for_name(name_data, year, rank, name):
    """
    :param name_data: dict, the key is name, the value is a dictionary {year: rank}.
    :param year: str, a year
    :param rank: str, the rank of the baby name in the year
    :param name: str, baby name
    This function puts name, year, and rank in the name_data(dict).
    """
